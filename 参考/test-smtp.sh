...
if [ $# -eq 0 ]; then
    echo "用法: ./test-smtp.sh <host:port> [user] [password] [tls]"
    echo
    echo "示例:"
    echo "  ./test-smtp.sh smtp.gmail.com:587 user@gmail.com password true"
    echo "  ./test-smtp.sh smtp.gmail.com:465 user@gmail.com password true"
    echo "  ./test-smtp.sh mail.example.com:25"
    echo
    echo "常见SMTP服务器配置:"
