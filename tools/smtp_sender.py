...
def send_test_email():
    ...
    try:
        ...
        message["Subject"] = Header("SMTP发件测试 - 来自163邮箱", 'utf-8')
        
        # 邮件正文
        current_time = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        body = f"""这是一封来自163邮箱的测试邮件。
...
如果您收到这封邮件，说明163邮箱的SMTP发送功能正常。

接下来可以测试您的邮件系统是否能接收来自163邮箱的邮件：
请从163邮箱发送邮件到：kimi11@jbjj.site
...
"""
        ...
        print("📧 如果收到邮件，说明163邮箱SMTP发送功能正常")
        print("")
        print("🔄 下一步测试：")
        print("   请从163邮箱手动发送邮件到：kimi11@jbjj.site")
        print("   测试您的邮件系统是否能正确接收邮件")
        print("=" * 50)
